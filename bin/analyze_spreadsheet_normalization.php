...
function normalizeCategoryByDescription(string $normalizedDescription, array $base): ?array
{
    $rules = [
        ...
        [['FARMACIA', 'DENTISTA', 'SAUDE', 'REMEDIO', 'MEDICO MAITE', 'ACADEMIA', 'KIT MANICURE ISA', 'JOAO LIMA INJECAO ISADORA', 'LUCIA PODOLOGA', 'STARCLIN', 'SANTA CASA EXAME COVID'], 'SAUDE', 'SAÚDE'],
        [['NISSEI'], 'SAUDE', 'SAÚDE'],
        ...
        [['ALUGUEL', 'AUXILIO EM CASA'], 'ALUGUEL', 'ALUGUEL'],
        [['CARRO 44', 'CARRO 45', 'CARRO 46', 'CARRO 47', 'CARRO 48'], 'FINANC VEICULAR', 'FINANC. VEICULAR'],
        ...
        [['MICROSIS', 'THAIS CRISTINA DE LIMA', 'ADVOGADO BRUNO', 'BRUNO FABRETTI ADVOGADO', 'PARTE MAYCON'], 'DESP EMPRESA', 'DESP. EMPRESA'],
        ...
        [['CAMISETA PITICAS', 'PERNAMBUCANAS', 'KIT CUECA', 'KIT COTURNO', 'TENIS CINTO MEIA', 'UNIFORME MARISA MODAS', 'LUVA MAURICIO', 'KIT TENIS', 'KIT CAMISA', 'KIT SHORT', 'TENIS', 'MEIA LUPO', 'CALCA MOLETOM', 'MOLETOM FUEL TECH', 'BLUSA KARINA', 'JALECO KARINA', 'TUDO10 BIKINI LINGUI PORTA', 'LENCOL CAMA'], 'VESTUARIO', 'VESTUÁRIO'],
