...
function normalizeCategoryByDescription(string $normalizedDescription, array $base): ?array
{
    $rules = [
        ...
        [['BIPE SNIPER', 'STEAM DLC ETS2', 'PRISTON TALE', 'EURO TRUCK COMPLETO', 'EURO TRUCK GOING EAST', 'JOGO CITIES SKYLINES', 'LUNETA SNIPER', 'KIT MILITAR', 'KIT CAPACETE AIRSOFT', 'FARDA AIRSOFT'], 'INVEST MAURICIO', 'INVEST. MAURICIO'],
        [['TNS CABOS', 'TNS FONTE PC SONECA', 'CAPACITOR ELETROLITICO', 'FLAT NOTEBOOK FABRETTI', 'FLAT NOTEBOOK DELL', 'CHIP IPHONE GVEI', 'TECLADO NOTE GUI SEMP', 'MODEM ROTEADOR 3G', 'INVERTER NOTEBOOK DELL FERNANDA', 'ANTENA EXTERNA'], 'TECNOLOGIA', 'TECNOLOGIA'],
