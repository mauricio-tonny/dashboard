...
function normalizeCategoryByDescription(string $normalizedDescription, array $base): ?array
{
    $rules = [
        ...
        [['UBER', 'EQUIPS AIRSOFT', 'CATUAI ESTACIONAMENTO', 'BANCO IMOBILIARIO', 'CINEMA BOULEVARD', 'CINEMARK', 'BRITOS ROLE', 'RACA NEGRA', '2800 DESPESA', 'SIMPLA EVENTO GOOGLE', 'VIACAO GARCIA', 'TRANSITO ESTACIONAMENTO'], 'DIVERSAO PASSEIO', 'DIVERSÃO/PASSEIO'],
