...
function normalizeCategoryByDescription(string $normalizedDescription, array $base): ?array
{
    $rules = [
        ...
        [['NOVA MARIVAL'], 'EDUCACAO', 'EDUCACAO'],
        ...
        [['MAKITA', 'CAPACETE MERCADO LIVRE', 'SAO JOAO CARTAO UMIDIF', 'MERCADO LIVRE MALETA', 'LUVA MERC LIVRE', 'POLTRONA MARCIO', 'MANINHO CAPACETE', 'JOGO DE FACA RUBIA E FELIPI', 'KIT JARDINAGEM MARA', 'KIT CROCHET MARA'], 'AQUISICAO', 'AQUISIÇÃO'],
        ...
        [['MOTOR VIRAGO', 'BATERIA VIRAGO', 'PECAS VIRAGO', 'CENTER CAR', 'MOTO JANEIRO FEV', 'CORRENTE MOTO', 'MANOPLA COIFA COCKPIT', 'ENGRENAGEM BOMBA DE OLEO', 'SENSOR DE OLEO VIRAGO'], 'MANUT VEICULO', 'MANUT. VEICULO'],
        [['BIPE SNIPER', 'STEAM DLC ETS2', 'PRISTON TALE', 'EURO TRUCK COMPLETO', 'EURO TRUCK GOING EAST'], 'INVEST MAURICIO', 'INVEST. MAURICIO'],
        [['TNS CABOS', 'CAPACITOR ELETROLITICO', 'FLAT NOTEBOOK FABRETTI'], 'TECNOLOGIA', 'TECNOLOGIA'],
