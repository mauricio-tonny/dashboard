...
function normalizeCategoryByDescription(string $normalizedDescription, array $base): ?array
{
    $rules = [
        ...
        [['MAKITA', 'CAPACETE MERCADO LIVRE', 'SAO JOAO CARTAO UMIDIF', 'MERCADO LIVRE MALETA', 'LUVA MERC LIVRE', 'POLTRONA MARCIO', 'MANINHO CAPACETE', 'JOGO DE FACA RUBIA E FELIPI', 'KIT JARDINAGEM MARA'], 'AQUISICAO', 'AQUISIÇÃO'],
        ...
        [['MOTOR VIRAGO', 'BATERIA VIRAGO', 'PECAS VIRAGO', 'CENTER CAR', 'MOTO JANEIRO FEV', 'CORRENTE MOTO'], 'MANUT VEICULO', 'MANUT. VEICULO'],
