...
function normalizeCategoryByDescription(string $normalizedDescription, array $base): ?array
{
    ...
    $rules = [
        ...
        [['CAMISETA PITICAS', 'PERNAMBUCANAS', 'KIT CUECA', 'KIT COTURNO', 'TENIS CINTO MEIA', 'UNIFORME MARISA MODAS', 'LUVA MAURICIO', 'LUVA MOTO', 'KIT TENIS', 'KIT CAMISA', 'KIT SHORT', 'TENIS', 'MEIA LUPO', 'CALCA MOLETOM', 'MOLETOM FUEL TECH', 'BLUSA KARINA', 'JALECO KARINA', 'TUDO10 BIKINI LINGUI PORTA', 'LENCOL CAMA'], 'VESTUARIO', 'VESTUÁRIO'],
