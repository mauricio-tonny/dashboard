...
function normalizeCategoryByDescription(string $normalizedDescription, array $base): ?array
{
    $rules = [
        ...
        [['PADOKA', 'IFOOD', 'LANCHE', 'VADECO', 'SANTA PIZZA', 'COSTELA GRILL', 'DOG KING', 'PIZZARIA DOM PARMELO', 'BUONN FRATELLO PIZZARIA', 'GELA BOCA', 'DELLA PAZZETTI'], 'ALIMENTACAO', 'ALIMENTAÇÃO'],
        ...
        [['UBER', 'EQUIPS AIRSOFT'], 'DIVERSAO PASSEIO', 'DIVERSÃO/PASSEIO'],
        ...
        [['BIPE SNIPER'], 'INVEST MAURICIO', 'INVEST. MAURICIO'],
