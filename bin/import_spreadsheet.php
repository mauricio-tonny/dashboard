...
function normalizeCategoryByDescription(string $normalizedDescription, array $base): ?array
{
    $rules = [
        ...
        [['SUP CENTER', 'SUPERMERCADO', 'MAXI LIMPEZA'], 'MERCADO', 'MERCADO'],
        [['SPOTIFY'], 'STREAMING', 'STREAMING'],
        [['PADOKA', 'IFOOD', 'LANCHE', 'VADECO', 'SANTA PIZZA', 'COSTELA GRILL', 'DOG KING', 'PIZZARIA DOM PARMELO', 'BUONN FRATELLO PIZZARIA', 'GELA BOCA', 'DELLA PAZZETTI', 'PIZZARIA DELLA NONA', 'RESTAURANTE', 'BURGER KING', 'COSTELA', 'VILA ITALIA', 'REST COSTELA', 'STRASSBERG', 'HANGAR', 'PIZZARIA VILA ITALIA', 'BUENO BURGER', 'TODO TORTO'], 'ALIMENTACAO', 'ALIMENTAÇÃO'],
        ...
        [['CLASSICS'], 'CUIDADOS PESSOAIS', 'CUIDADOS PESSOAIS'],
        [['PETITE BOX', 'LEITE MAITE', 'NISSEI MAITE'], 'INFANTIL', 'INFANTIL'],
        [['FARMACIA', 'DENTISTA', 'SAUDE', 'REMEDIO'], 'SAUDE', 'SAÚDE'],
        [['NISSEI'], 'SAUDE', 'SAÚDE'],
        ...
        [['UBER', 'EQUIPS AIRSOFT', 'CATUAI ESTACIONAMENTO'], 'DIVERSAO PASSEIO', 'DIVERSÃO/PASSEIO'],
        [['MAKITA', 'CAPACETE MERCADO LIVRE', 'SAO JOAO CARTAO UMIDIF', 'MERCADO LIVRE MALETA', 'LUVA MERC LIVRE'], 'AQUISICAO', 'AQUISIÇÃO'],
        [['TELHANORTE'], 'REFORMA MANUT', 'REFORMA/MANUT.'],
        ...
        [['MOTOR VIRAGO', 'BATERIA VIRAGO'], 'MANUT VEICULO', 'MANUT. VEICULO'],
        [['BIPE SNIPER', 'STEAM DLC ETS2'], 'INVEST MAURICIO', 'INVEST. MAURICIO'],
        [['TNS CABOS'], 'TECNOLOGIA', 'TECNOLOGIA'],
        [['CAMISETA PITICAS'], 'VESTUARIO', 'VESTUÁRIO'],
