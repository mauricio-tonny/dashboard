...
{
    $rules = [
        [['SUP CIDADE CANCAO', 'SUP CANCAO', 'SUP CID CANCAO', 'CANCAO', 'BOX ATACADISTA', 'SUP LONDRINA', 'MOLINIS SUP'], 'MERCADO', 'MERCADO'],
        ...
        [['PADOKA', 'IFOOD', 'LANCHE', 'VADECO', 'SANTA PIZZA', 'COSTELA GRILL', 'DOG KING', 'PIZZARIA DOM PARMELO', 'DOM PARMELO', 'BUONN FRATELLO PIZZARIA', 'GELA BOCA', 'DELLA PAZZETTI', 'PIZZARIA DELLA NONA', 'PIZZARIA DELLA NONNA', 'DELLA NONA', 'PADARIA JOIA', 'JOIA', 'RESTAURANTE', 'BURGER KING', 'COSTELA', 'VILA ITALIA', 'REST COSTELA', 'STRASSBERG', 'HANGAR', 'PIZZARIA VILA ITALIA', 'BUENO BURGER', 'TODO TORTO', 'REST DOM JOAQUIM', 'CROASSONHO', 'CROASONHO', 'PIZZARIA FORNINHO', 'LA MAFIA HAMBURG', 'LOS BRAGAS', 'PIZZARIA CAPRIOLLI', 'PIZZARIA NOVA PACHECO', 'PIZZA POPEDI', 'PIZZA', 'PEDACOS DE AMOR', 'GELOBEL LANC DON PABLO', 'GELOBEL', 'SUBWAY', 'PIZZARIA LAS VEGAS', 'KOJO', 'BEBIDAS', 'CHIQUINHO', 'TROPICANA', 'ESTACAO PROCOPIO', 'HACHIMITSU', 'FOOD TRUCK'], 'ALIMENTACAO', 'ALIMENTAÇÃO'],
        ...
        [['MOTOR VIRAGO', 'BATERIA VIRAGO', 'PECAS VIRAGO', 'CENTER CAR', 'MOTO JANEIRO FEV', 'CORRENTE MOTO', 'RELE VIRAGO', 'VOLANTE SAIDA DE AR COIFA', 'SUFILM GOL', 'MANOPLA COIFA COCKPIT', 'ENGRENAGEM BOMBA DE OLEO', 'SENSOR DE OLEO VIRAGO', 'JOGO DE JUNTA VIRAGO', 'KIT BIELA VIRAGO', 'KIT PISTAO BIZ 100 ANEL', 'CANETINHA PNEU', 'MANINHO CARBURADOR', 'COLETOR VIRAGO', 'MOTO MAYCON', 'CDI VIRAGO', 'CABO AC REPARO PROMOTOS', 'BOBINA VIRAGO', 'CABO AC VIRAGO', 'FILTRO ESPORTIVO VIR', 'RACE CUSTOM VIRAGO', 'RACECUSTOM', 'GRELHA VIRAGO', 'RELACAO VIRAGO WM MOTO', 'FAROL FREIO VIRAGO', 'EIXO QUADRO VIRAGO', 'KIT RAIO VIRAGO', 'KIT SETA VIRAGO', 'ELETRICA VIRAGO', 'PNEU VIRAGO', 'CABO DO FREIO TRAS', 'PNEU CG 150', 'MANINHO REF VIRAGO', 'CBR 450SR MANINHO', 'ALI EXPRESS ADAPTADOR RETROVISOR', 'KIT ADESIVO ML', 'KIT LATERAL ML', 'KIT EMBLEMA ML'], 'MANUT VEICULO', 'MANUT. VEICULO'],
        ...
        [['TNS CABOS', 'TNS FONTE PC SONECA', 'CAPACITOR ELETROLITICO', 'FLAT NOTEBOOK FABRETTI', 'FLAT NOTEBOOK DELL', 'CHIP IPHONE GVEI', 'TECLADO NOTE GUI SEMP', 'TECLADO NOTE KAREN', 'MODEM ROTEADOR 3G', 'ACCESS POINT INTELBRAS', 'INVERTER NOTEBOOK DELL FERNANDA', 'ANTENA EXTERNA', 'HD SSD', 'SSD'], 'TECNOLOGIA', 'TECNOLOGIA'],
