...
function normalizeCategoryByDescription(string $normalizedDescription, array $base): ?array
{
    $rules = [
        ...
        [['FARMACIA', 'DENTISTA', 'SAUDE', 'REMEDIO', 'KIT MANICURE ISA', 'JOAO LIMA INJECAO ISADORA', 'LUCIA PODOLOGA', 'STARCLIN'], 'SAUDE', 'SAÚDE'],
        [['NISSEI'], 'SAUDE', 'SAÚDE'],
        ...
        [['BIPE SNIPER', 'STEAM DLC ETS2', 'DLC ETS2', 'LEFT 4 DEAD', 'ONG ORAR F75', 'ONG RETORNAR HD 883', 'PRISTON TALE', 'EURO TRUCK COMPLETO', 'EURO TRUCK GOING EAST', 'JOGO CITIES SKYLINES', 'VOLANTE SCANIA', 'LOGITECH G27', 'JOYSTICK AVIAO', 'LUNETA SNIPER', 'KIT MILITAR', 'KIT CAPACETE AIRSOFT', 'FARDA AIRSOFT', 'GTA V'], 'INVEST MAURICIO', 'INVEST. MAURICIO'],
