...
{
    $rules = [
        [['SUP CIDADE CANCAO', 'SUP CANCAO', 'SUP CID CANCAO', 'CANCAO', 'BOX ATACADISTA', 'SUP LONDRINA', 'MOLINIS SUP', 'ACOUGUE CARNE', 'ACOUGUE SAO JOSE', 'AMERICANAS', 'REFRIGERANTE CONQUISTA'], 'MERCADO', 'MERCADO'],
        ...
        [['PADOKA', 'IFOOD', 'LANCHE', 'VADECO', 'SANTA PIZZA', 'COSTELA GRILL', 'DOG KING', 'PIZZARIA DOM PARMELO', 'DOM PARMELO', 'BUONN FRATELLO PIZZARIA', 'GELA BOCA', 'DELLA PAZZETTI', 'PIZZARIA DELLA NONA', 'PIZZARIA DELLA NONNA', 'DELLA NONA', 'PADARIA JOIA', 'PADARIA', 'JOIA', 'RESTAURANTE', 'BURGER KING', 'BUENOS BURGER', 'DI BURGER', 'COSTELA', 'COSTELLA', 'VILA ITALIA', 'REST COSTELA', 'STRASSBERG', 'HANGAR', 'PIZZARIA VILA ITALIA', 'BUENO BURGER', 'TODO TORTO', 'REST DOM JOAQUIM', 'CROASSONHO', 'CROASONHO', 'PIZZARIA FORNINHO', 'LA MAFIA HAMBURG', 'LOS BRAGAS', 'PIZZARIA CAPRIOLLI', 'PIZZARIA NOVA PACHECO', 'PIZZA POPEDI', 'PIZZA', 'PEDACOS DE AMOR', 'GELOBEL LANC DON PABLO', 'GELOBEL', 'SUBWAY', 'PIZZARIA LAS VEGAS', 'KOJO', 'BEBIDAS', 'CHIQUINHO', 'TROPICANA', 'ESTACAO PROCOPIO', 'HACHIMITSU', 'FOOD TRUCK', 'SORVETERIA KI DELICIA', 'BENDROLL', 'BEND ROLL', 'BEND E ROLL', 'PAO E VINHO FRANGO ASSADO', 'CHULETA MALUCA STEAKBAR', 'CAFE DO PARQUE', 'PETISCARIA DIMIRSU', 'RICKS STREET FOOD INBOX', 'REST TRADI MINEIRA', 'RANCHO DOS PAMPAS REST', 'MC DONALDS SORVETE', 'DOCE HISTORIA CAFE', 'ACAI WAVE', 'PONTO GRILL BOULEVARD'], 'ALIMENTACAO', 'ALIMENTAÇÃO'],
        ...
        [['UBER', 'EQUIPS AIRSOFT', 'CATUAI ESTACIONAMENTO', 'BANCO IMOBILIARIO', 'CINEMA BOULEVARD', 'CINEMARK', 'BRITOS ROLE', 'RACA NEGRA', '2800 DESPESA', 'SIMPLA EVENTO GOOGLE', 'VIACAO GARCIA', 'TRANSITO ESTACIONAMENTO', 'ESTACIONAMENTO RIZZO', 'VIAGEM', 'PLATINUM'], 'DIVERSAO PASSEIO', 'DIVERSÃO/PASSEIO'],
        [['MAKITA', 'CAPACETE MERCADO LIVRE', 'SAO JOAO CARTAO UMIDIF', 'MERCADO LIVRE MALETA', 'LUVA MERC LIVRE', 'POLTRONA MARCIO', 'MANINHO CAPACETE', 'JOGO DE FACA', 'KIT JARDINAGEM MARA', 'KIT CROCHET MARA', 'PRESENTE MARA', 'PRESENTE ISADORA', 'PRESENTE MAE DA ISA', 'MOCHILA ISADORA', 'KIT AGULHA MARA', 'SERRA COPO WD40', 'KIT POLIMENTO', 'KIT CHAVE CATRACA', 'FERRAMENTAS ELETROTRAFO', 'PRESENTE TAI', 'AMORT CADEIRA UNIMAQ', 'AMIGO SECRETO E PERFUME', 'KIT BROCA CHINA', 'BANDOLEIRA', 'LANTERNA TATICA', 'RADIO BAOFENG', 'RELOGIO CHINA', 'FLORES SHOPPING', 'CAPACETE 1 3', 'CAPACETE 2 3', 'CAPACETE 3 3', 'ALGO DO MAYCON', 'MATERIAIS ELETRICOS', 'PGTO CHICOTE MAURICIO', 'TV LG SMART 49 LED 4K', 'PLIMOR', 'CAMISAS MAYCON', 'SOM QUARTO', 'CABO SOM'], 'AQUISICAO', 'AQUISIÇÃO'],
        [['TELHANORTE', 'DEP SAO LUIS', 'DEP SAO LUIZ', 'BOX BANHEIRO', 'CATIVA TELA MOSQUITEIRA', 'ELETROTRAFO RESISTENCIA CHUV', 'ELETROBARROS RESISTENCIA'], 'REFORMA MANUT', 'REFORMA/MANUT.'],
        ...
        [['MOTOR VIRAGO', 'BATERIA VIRAGO', 'PECAS VIRAGO', 'CENTER CAR', 'MOTO JANEIRO FEV', 'CORRENTE MOTO', 'RELE VIRAGO', 'VOLANTE SAIDA DE AR COIFA', 'SUFILM GOL', 'CONNECT GOL', 'PARACHOQUE GOL', 'KIT BOTAO GOL', 'CALOTA GOL', 'PLACA DE PARTIDA VIRAGO', 'WM MOTOPECAS', 'MANUTENCAO GOL EMBRAGENS COPRO', 'OLEO VIRAGO', 'FILTRO DE OLEO VIRAGO', 'MANOPLA COIFA COCKPIT', 'ENGRENAGEM BOMBA DE OLEO', 'SENSOR DE OLEO VIRAGO', 'JOGO DE JUNTA VIRAGO', 'KIT BIELA VIRAGO', 'KIT PISTAO BIZ 100 ANEL', 'CANETINHA PNEU', 'MANINHO CARBURADOR', 'COLETOR VIRAGO', 'MOTO MAYCON', 'CDI VIRAGO', 'CABO AC REPARO PROMOTOS', 'BOBINA VIRAGO', 'CABO AC VIRAGO', 'FILTRO ESPORTIVO VIR', 'RACE CUSTOM VIRAGO', 'RACECUSTOM', 'GRELHA VIRAGO', 'RELACAO VIRAGO WM MOTO', 'FAROL FREIO VIRAGO', 'EIXO QUADRO VIRAGO', 'KIT RAIO VIRAGO', 'KIT SETA VIRAGO', 'ELETRICA VIRAGO', 'PNEU VIRAGO', 'CABO DO FREIO TRAS', 'PNEU CG 150', 'MANINHO REF VIRAGO', 'CBR 450SR MANINHO', 'ALI EXPRESS ADAPTADOR RETROVISOR', 'KIT ADESIVO ML', 'KIT LATERAL ML', 'KIT EMBLEMA ML'], 'MANUT VEICULO', 'MANUT. VEICULO'],
        [['BIPE SNIPER', 'STEAM DLC ETS2', 'DLC ETS2', 'LEFT 4 DEAD', 'PRISTON TALE', 'EURO TRUCK COMPLETO', 'EURO TRUCK GOING EAST', 'JOGO CITIES SKYLINES', 'VOLANTE SCANIA', 'LOGITECH G27', 'LUNETA SNIPER', 'KIT MILITAR', 'KIT CAPACETE AIRSOFT', 'FARDA AIRSOFT', 'GTA V'], 'INVEST MAURICIO', 'INVEST. MAURICIO'],
        [['TNS CABOS', 'TNS FONTE PC SONECA', 'CAPACITOR ELETROLITICO', 'FLAT NOTEBOOK FABRETTI', 'FLAT NOTEBOOK DELL', 'CHIP IPHONE GVEI', 'TECLADO NOTE GUI SEMP', 'TECLADO NOTE KAREN', 'MODEM ROTEADOR 3G', 'ACCESS POINT INTELBRAS', 'BATERIA NOBREAK', 'FONE AKG', 'MOCHILA ACER', 'PLACA DE VIDEO', 'INVERTER NOTEBOOK DELL FERNANDA', 'ANTENA EXTERNA', 'HD SSD', 'SSD'], 'TECNOLOGIA', 'TECNOLOGIA'],
        [['CAMISETA PITICAS', 'KIT CUECA', 'KIT COTURNO', 'TENIS CINTO MEIA', 'UNIFORME MARISA MODAS', 'LUVA MAURICIO', 'KIT TENIS', 'KIT CAMISA', 'KIT SHORT', 'TENIS', 'MEIA LUPO', 'LENCOL CAMA'], 'VESTUARIO', 'VESTUÁRIO'],
        [['RIACHUELO'], 'VESTUARIO', 'VESTUÁRIO'],
        [['LUZ CAMILA TESTE', 'PORTA DE PAPEL BUZZ', 'ITENS ELETRICOS BUZZ'], 'BUZZ', 'BUZZ'],
    ];
