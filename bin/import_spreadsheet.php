...
function normalizeCategoryByDescription(string $normalizedDescription, array $base): ?array
{
    ...
    $rules = [
        [['SUP CIDADE CANCAO', 'SUP CANCAO', 'SUP CID CANCAO', 'CANCAO', 'BOX ATACADISTA', 'SUP LONDRINA', 'MOLINIS SUP', 'SUP MOLINIS', 'SUP CONDOR', 'ACOUGUE CARNE', 'ACOUGUE SAO JOSE', 'ATAK MERCEARIA', 'EMELINE AROMAS', 'LUVA DESC TALGE', 'CERVEJA NILDO CAMILO', 'PANIF PAO PURO', 'AMERICANAS', 'REFRIGERANTE CONQUISTA'], 'MERCADO', 'MERCADO'],
        ...
        [['PETITE BOX', 'LEITE MAITE', 'NISSEI MAITE', 'FRALDA PAMPERS', 'BABA MAITE', 'MALUKINHA KIDS'], 'INFANTIL', 'INFANTIL'],
        [['FARMACIA', 'DENTISTA', 'SAUDE', 'REMEDIO', 'MEDICO MAITE', 'FARMACINHA DA MAITE', 'AMAZON BICO CHUPETA', 'CECOR EXAME', 'USIFARMA VERONA', 'ACADEMIA', 'KIT MANICURE ISA', 'JOAO LIMA INJECAO ISADORA', 'LUCIA PODOLOGA', 'STARCLIN', 'SANTA CASA EXAME COVID'], 'SAUDE', 'SAÚDE'],
        [['NISSEI'], 'SAUDE', 'SAÚDE'],
        ...
        [['BUSAO', 'NOVA MARIVAL', 'CERTIF PITAGORAS', 'APOSTILA ST MICROCOPY', 'MAT ESCOLAR MARIVAL', 'MAT ESCOLAR ISADORA', 'CADERNO ISADORA', 'LIVRARIAS CURITIBA', 'CURSO UDEMY'], 'EDUCACAO', 'EDUCACAO'],
