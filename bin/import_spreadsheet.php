...
function normalizeCategoryByDescription(string $normalizedDescription, array $base): ?array
{
    $rules = [
        ...
        [['CAMISETA PITICAS', 'KIT CUECA', 'KIT COTURNO', 'TENIS CINTO MEIA', 'UNIFORME MARISA MODAS'], 'VESTUARIO', 'VESTUÁRIO'],
