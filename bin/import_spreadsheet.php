...
function normalizeCategoryByDescription(string $normalizedDescription, array $base): ?array
{
    $rules = [
        ...
        [['FARMACIA', 'DENTISTA', 'SAUDE', 'REMEDIO', 'ACADEMIA', 'KIT MANICURE ISA', 'JOAO LIMA INJECAO ISADORA', 'LUCIA PODOLOGA', 'STARCLIN', 'SANTA CASA EXAME COVID'], 'SAUDE', 'SAÚDE'],
        [['NISSEI'], 'SAUDE', 'SAÚDE'],
        [['CREDITO CELULAR', 'PLANO TIM', 'PLANO CLARO', 'MAYCON TIM'], 'TELEFONIA', 'TELEFONIA'],
        [['CELULAR MAURICIO'], 'TELEFONIA', 'TELEFONIA'],
        [['INTERNET BRASILNET', 'INTERNET VISAONET', 'BRASILNET INSTALACAO'], 'INTERNET', 'INTERNET'],
        [['IPVA', 'DOC MOTO', 'MULTA HEHE', 'LICENCIAMENTO'], 'IPVA', 'IPVA'],
        ...
        [['CARRO 45', 'CARRO 46', 'CARRO 47', 'CARRO 48'], 'FINANC VEICULAR', 'FINANC. VEICULAR'],
        ...
        [['MICROSIS', 'THAIS CRISTINA DE LIMA', 'ADVOGADO BRUNO'], 'DESP EMPRESA', 'DESP. EMPRESA'],
