...
function normalizeCategoryByDescription(string $normalizedDescription, array $base): ?array
{
    $rules = [
        ...
        [['TNS CABOS', 'TNS FONTE PC SONECA', 'FONTE 500W EVA', 'CAPACITOR ELETROLITICO', 'FLAT NOTEBOOK FABRETTI', 'FLAT NOTEBOOK DELL', 'CHIP IPHONE GVEI', 'TECLADO NOTE GUI SEMP', 'TECLADO NOTE KAREN', 'REGISTROBR', 'MODEM ROTEADOR 3G', 'ACCESS POINT INTELBRAS', 'BATERIA NOBREAK', 'FONE AKG', 'HOSPEDAGEM MAYCON', 'MOCHILA ACER', 'PLACA DE VIDEO', 'INVERTER NOTEBOOK DELL FERNANDA', 'ANTENA EXTERNA', 'HD SSD', 'SSD'], 'TECNOLOGIA', 'TECNOLOGIA'],
        [['CAMISETA PITICAS', 'KIT CUECA', 'KIT COTURNO', 'TENIS CINTO MEIA', 'UNIFORME MARISA MODAS', 'LUVA MAURICIO', 'KIT TENIS', 'KIT CAMISA', 'KIT SHORT', 'TENIS', 'MEIA LUPO', 'CALCA MOLETOM', 'BLUSA KARINA', 'LENCOL CAMA'], 'VESTUARIO', 'VESTUÁRIO'],
        [['RIACHUELO'], 'VESTUARIO', 'VESTUÁRIO'],
        [['LUZ CAMILA TESTE', 'FUNWORK TESTE', 'PORTA DE PAPEL BUZZ', 'ITENS ELETRICOS BUZZ', 'TOK PLENO TESTE BUZZ'], 'BUZZ', 'BUZZ'],
    ];
