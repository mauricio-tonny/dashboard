...
{
    $rules = [
        [['SUP CIDADE CANCAO', 'SUP CANCAO', 'SUP CID CANCAO', 'CANCAO', 'BOX ATACADISTA', 'SUP LONDRINA', 'MOLINIS SUP', 'ACOUGUE CARNE', 'AMERICANAS'], 'MERCADO', 'MERCADO'],
        ...
        [['PADOKA', 'IFOOD', 'LANCHE', 'VADECO', 'SANTA PIZZA', 'COSTELA GRILL', 'DOG KING', 'PIZZARIA DOM PARMELO', 'DOM PARMELO', 'BUONN FRATELLO PIZZARIA', 'GELA BOCA', 'DELLA PAZZETTI', 'PIZZARIA DELLA NONA', 'PIZZARIA DELLA NONNA', 'DELLA NONA', 'PADARIA JOIA', 'PADARIA', 'JOIA', 'RESTAURANTE', 'BURGER KING', 'BUENOS BURGER', 'DI BURGER', 'COSTELA', 'VILA ITALIA', 'REST COSTELA', 'STRASSBERG', 'HANGAR', 'PIZZARIA VILA ITALIA', 'BUENO BURGER', 'TODO TORTO', 'REST DOM JOAQUIM', 'CROASSONHO', 'CROASONHO', 'PIZZARIA FORNINHO', 'LA MAFIA HAMBURG', 'LOS BRAGAS', 'PIZZARIA CAPRIOLLI', 'PIZZARIA NOVA PACHECO', 'PIZZA POPEDI', 'PIZZA', 'PEDACOS DE AMOR', 'GELOBEL LANC DON PABLO', 'GELOBEL', 'SUBWAY', 'PIZZARIA LAS VEGAS', 'KOJO', 'BEBIDAS', 'CHIQUINHO', 'TROPICANA', 'ESTACAO PROCOPIO', 'HACHIMITSU', 'FOOD TRUCK', 'SORVETERIA KI DELICIA', 'BENDROLL', 'BEND ROLL', 'BEND E ROLL', 'PAO E VINHO FRANGO ASSADO', 'CHULETA MALUCA STEAKBAR', 'CAFE DO PARQUE', 'DOCE HISTORIA CAFE', 'ACAI WAVE', 'PONTO GRILL BOULEVARD'], 'ALIMENTACAO', 'ALIMENTAÇÃO'],
        ...
        [['UBER', 'EQUIPS AIRSOFT', 'CATUAI ESTACIONAMENTO', 'BANCO IMOBILIARIO', 'CINEMA BOULEVARD', 'CINEMARK', 'BRITOS ROLE', 'RACA NEGRA', '2800 DESPESA', 'SIMPLA EVENTO GOOGLE', 'VIACAO GARCIA', 'TRANSITO ESTACIONAMENTO', 'PLATINUM'], 'DIVERSAO PASSEIO', 'DIVERSÃO/PASSEIO'],
        ...
        [['TELHANORTE', 'DEP SAO LUIS', 'DEP SAO LUIZ', 'BOX BANHEIRO', 'ELETROTRAFO RESISTENCIA CHUV'], 'REFORMA MANUT', 'REFORMA/MANUT.'],
