...
function normalizeCategoryByDescription(string $normalizedDescription, array $base): ?array
{
    $rules = [
        ...
        [['SUP CENTER'], 'MERCADO', 'MERCADO'],
        [['SPOTIFY'], 'STREAMING', 'STREAMING'],
        [['PADOKA', 'IFOOD', 'LANCHE', 'VADECO', 'SANTA PIZZA', 'COSTELA GRILL', 'DOG KING'], 'ALIMENTACAO', 'ALIMENTAÇÃO'],
        ...
        [['MAKITA', 'CAPACETE MERCADO LIVRE', 'SAO JOAO CARTAO UMIDIF'], 'AQUISICAO', 'AQUISIÇÃO'],
        ...
        [['ANUIDADE CARTAO'], 'INVESTIMENTO', 'INVESTIMENTO'],
