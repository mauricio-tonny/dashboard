...
function normalizeCategoryByDescription(string $normalizedDescription, array $base): ?array
{
    ...
    $patternRules = [
        ...
        ['/^(C A TINTAS\s+\d\s+2)$/', 'REFORMA MANUT', 'REFORMA/MANUT.'],
    ...
    $rules = [
        ...
        [['PETSHOP CANTINHOS', 'LOJAO RURAL'], 'PET', 'PET'],
        ...
        [['FARMACIA', 'DENTISTA', 'SAUDE', 'REMEDIO', 'MEDICO MAITE', 'FARMACINHA DA MAITE', 'AMAZON BICO CHUPETA', 'CECOR EXAME', 'USIFARMA VERONA', 'GFARMA AVENIDA', 'FRALDA BAYGON KARINA', 'FRALDA MAITE', 'DROGA RAIA', 'ACADEMIA', 'KIT MANICURE ISA', 'JOAO LIMA INJECAO ISADORA', 'LUCIA PODOLOGA', 'STARCLIN', 'SANTA CASA EXAME COVID'], 'SAUDE', 'SAÚDE'],
        [['NISSEI'], 'SAUDE', 'SAÚDE'],
